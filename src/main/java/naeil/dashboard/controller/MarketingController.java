...
public class MarketingController {
    ...
    public ResponseEntity<Map<String, Object>> getNaverCpcPerformance(
        ...
        return ResponseEntity.ok(marketingService.getNaverCpcPerformance(from, to, adType));
    }

    @PostMapping("/naver-cpc/refresh-today")
    public ResponseEntity<Map<String, Object>> refreshTodayNaverCpcPerformance() {
        return ResponseEntity.ok(marketingService.refreshTodayNaverCpcPerformance());
    }
