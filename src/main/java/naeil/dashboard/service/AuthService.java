...
public class AuthService {
    ...
    public Optional<AuthUser> authenticateToken(String token) {
    ...
    public List<Map<String, Object>> listUsers() {
        return jdbcTemplate.queryForList("""
                SELECT id, username, display_name, department, position_name, role, status, last_login_at, created_at
                FROM dashboard_user
    ...
    private Optional<AuthUser> findUser(String username) {
        ...
        try {
            return Optional.ofNullable(jdbcTemplate.queryForObject("""
                    SELECT id, company_id, username, display_name, department, position_name, role, status
                    FROM dashboard_user
                    WHERE username = ?
